...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("goods", "0003_alter_category_options_alter_products_options_and_more"),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_on_get",
                    models.BooleanField(default=False, verbose_name="Payment on Get"),
                ),
                ("is_paid", models.BooleanField(default=False, verbose_name="Is Paid")),
                (
                    "status",
                    models.CharField(
                        default="In process", max_length=20, verbose_name="Status"
                    ),
                ),
                (
                    "user",
